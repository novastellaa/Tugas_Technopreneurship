...
<div class="container-fluid">
  ...
  <!-- <div class="row mt-3">
    <div class="col-md-1 text-break text-white p-3 align-self-center bg-danger">
    </div>
    <div class="col-md-5 p-3 bg-dark">
    <img src="assets/image/website/about/<?php echo $company_img?>" class="img-thumbnail" alt="...">
    </div>
    <div class="col-md-6 text-break text-white p-4 fs-6 align-self-center bg-danger" align="justify">
    <?php
        echo $company_desc;
    ?>
    </div> -->
  ...
  <div class="row ">
    ...
    <h3 class="text-center container-fluid bg-dark text-white py-3 my-4 border-top">Kategori</h3>
    <div class="row row-cols-2 row-cols-md-6 g-4">
        ...
        <div class="col">
            ...
            <div class="card-footer text-center">
                <a class="btn btn-danger" href="katalog.php?search=<?php echo $row['nama_kategori']?>">Lihat Produk</a>
            </div>
            </div>
        </div>
        <?php
  ...
  <div class="row">
    ...
    <h3 class="text-center container-fluid bg-dark text-white py-3 my-4 border-top">Produk</h3>
    <div class="row row-cols-2 row-cols-md-6 g-4">
        <?php
        ...
        <div class="col">
            ...
            <div class="card-footer text-center">
                <a class="btn btn-danger" href="https://api.whatsapp.com/send/?phone=62<?php echo $company_call; ?>&text=Order%20:%20<?php echo $row['nama_produk'];?>%20%0DHarga%20:%20Rp%20<?php echo $row['harga'];?>%20%0DTanggal%20:%20<?php echo $hari;?>" target="_BLANK">Pesan</a>
            </div>
            </div>
        </div>
        <?php
